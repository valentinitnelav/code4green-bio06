...
The Shannon diversity index indicates the diversity of the landscape. In this case, scenario 2 (only maze) has the lowest diversity index, however a fair amount of edge and patch density.
```{r, get-metrics}
